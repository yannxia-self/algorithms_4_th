...
public class KnuthMorrisPrattSubstringSearch {
    ...
    public KnuthMorrisPrattSubstringSearch(String pat) { // Build DFA from pattern.
        this.pat = pat;
        int M = pat.length();
        int R = 256;
        dfa = new int[R][M];
    ...
    public static void main(String[] args) {
        ...
        KnuthMorrisPrattSubstringSearch knuthMorrisPrattSubstringSearch = new KnuthMorrisPrattSubstringSearch("abc");

        int rs = knuthMorrisPrattSubstringSearch.search("aaaaabc");
